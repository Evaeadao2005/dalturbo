const getSaudacao = (adjustedHour) => {
    ...
    const saudações = {
        morning: "Bom dia! QUERO APROVEITAR A MEGA OFERTA 9,90 PRIMEIRO MÊS",
        afternoon: "Boa tarde! QUERO APROVEITAR A MEGA OFERTA 9,90 PRIMEIRO MÊS",
        night: "Boa noite! QUERO APROVEITAR A MEGA OFERTA 9,90 PRIMEIRO MÊS",
        earlyMorning: "Boa madrugada! QUERO APROVEITAR A MEGA OFERTA 9,90 PRIMEIRO MÊS",
    };
